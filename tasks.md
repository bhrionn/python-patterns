...
## Creational Patterns
- [x] Singleton - Ensures a class has only one instance and provides a global access point to it.
...
- [x] Command - Encapsulates a request as an object, allowing parameterization and queuing of requests.
...
- [x] Adapter - Converts one interface into another that clients expect, allowing incompatible interfaces to work together.
